...
path ="/home/yy452/rds/rds-gvdd-Yuap0gjVpKM/yy452/CLPsych2019_12/Dataset/task_b/combined_data_Task_B.csv"
all_data = dict()
...
for i, row in enumerate(reader_data):
    if(i == 0):
        continue
    if row[2] != 'SuicideWatch':
        all_data[(row[0], row[1])] = row
        

train_user_label_path ="/home/yy452/rds/rds-gvdd-Yuap0gjVpKM/yy452/CLPsych2019_12/Dataset/task_b/trainUserIds_TaskB_Final.csv"
...
taskB_path ="/home/yy452/rds/rds-gvdd-Yuap0gjVpKM/yy452/umd_reddit_suicidewatch_dataset_v2/crowd/train/task_B_train.posts.csv"
...
for user in taskB_user_posts:
    ...
    if user in train_user_id_label:
        ...
        if(label == ""):
            ...
            all_train_posts_of_users_combined.append([user_id, user_post_combined[13:], label])
...
with open("/home/yy452/rds/rds-gvdd-Yuap0gjVpKM/yy452/CLPsych2019_12/Dataset/task_b_dual/Train_Data_non_Suicide.tsv",'w', encoding = 'utf8', newline='') as outcsv:
