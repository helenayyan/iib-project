...
taskA_path ="C:\\CLPsych Challenge\\Dataset\\clpsych19_training_data\\task_C_train.posts.csv"
...
with open("C:\\CLPsych Challenge\\Dataset\\PreProcessing\\Only_User_Posts_Train_Task_C.txt",'w', encoding = 'utf8', newline='') as outcsv:   
...
import json
with open('C:\\CLPsych Challenge\\Dataset\\PreProcessing\\User_To_Posts_Train_Task_C.json', 'w') as fp:
