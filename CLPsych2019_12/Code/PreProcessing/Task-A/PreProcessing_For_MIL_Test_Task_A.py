...
with open("C:\\CLPsych Challenge\\Dataset\\PreProcessing\\Only_User_Posts_Test_Task_A.txt",'w', encoding = 'utf8', newline='') as outcsv:   
...
import json
with open('C:\\CLPsych Challenge\\Dataset\\PreProcessing\\User_To_Posts_Test_Task_A.json', 'w') as fp:
